Ich erinnere an die bereits zuvor dargestellten Methoden "read-aloud" und "think-aloud", die nicht zwingend erforderlich, aber für mich hilfreich sind.  
...
Anschließend laden Sie die Audiodatei(en) bitte in folgenden Cloudordner:  
...
#### Starten Sie also jetzt einen beliebigen Sprachrekorder und klicken Sie dann auf den folgenden Link, um die Teilnehmerdokumente in einem neuen Tab zu öffnen.  