...
st.markdown("""Bitte lesen Sie die Informationen in der Einverständniserklärung bis Ihnen alle Aspekte ausreichend klar geworden sind, um an der Studie teilzunehmen.  
            Insofern Sie sich für die Teilnahme entscheiden, müssen Sie das Einverständnisformular vollständig ausfüllen. Sie erhalten dann erneut eine E-Mail, in der Sie Ihre Identität bestätigen müssen.  
            Dann ist Ihre Einverständniserklärung vollständig und Sie bekommen das Passwort für den Anamnesetrainer.  
